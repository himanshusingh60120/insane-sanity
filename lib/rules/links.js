...
export default async function linkRules(doc) {
  ...
  // ── LINK-01 · internal report links must carry the /report/ prefix ──────────
  // Baseline miss: the tea extract report links to
  //   /microfluidics-market-266            (no prefix)
  //   /report/dietary-supplements-market-2870  (with prefix)
  // Both resolve, so nothing looks broken, but the two forms split link equity
  // and make the analytics unusable.
